...
public class JavaExcelApp {
	...
	public static void main(String[] args) throws IOException {
		...
		Sheet sheet0 = wb.createSheet(WorkbookUtil.createSafeSheetName("АКТ"));
		Row row = sheet0.createRow(1);
		Cell cell = row.createCell(8);
		cell.setCellValue("152"); //номер акта
		
		Cell cell1 = row.createCell(10);
		cell1.setCellValue("25.06.1968"); //от какого числа
		
		Row row1 = sheet0.createRow(3);
		Cell cell2 = row1.createCell(3);
		cell2.setCellValue("01.06.1968"); //период с 
		
		Cell cell21 = row1.createCell(6);
		cell21.setCellValue("25.06.1968");//период по
		
		Row row11 = sheet0.createRow(4);
		Cell cell211 = row11.createCell(10);
		cell211.setCellValue("25.06.1968"); //дата составления
		
		Row row111 = sheet0.createRow(10);
		Cell cell2111 = row111.createCell(1);
		cell2111.setCellValue("ЕЕЕ 1241268"); //номер полиса
		Cell cell21111 = row111.createCell(2);
		cell21111.setCellValue("Иванов Иван Иванович"); //Страхователь
		Cell cell211111 = row111.createCell(3);
		cell211111.setCellValue("25.11.2016"); //начало действия полиса
		Cell cell2111111 = row111.createCell(4);
		cell2111111.setCellValue("24.11.2017"); //конец действия полиса
		Cell cell2211 = row111.createCell(6);
		cell2211.setCellValue("12200"); //оплаченная премия
		Cell cell2311 = row111.createCell(7);
		cell2311.setCellValue("25.11.2016"); //дата оплаты
		Cell cell2411 = row111.createCell(8);
		cell2411.setCellValue("ВА 132670"); //номер квитанции
		
		Row row121 = sheet0.createRow(21);
		Cell cell2113 = row121.createCell(2);
		cell2113.setCellValue("Петров К.С."); //номер полиса
		...
		//Sheet sheet3 = wb.createSheet(WorkbookUtil.createSafeSheetName("рпвыаравы5ваыпправ%"));//пример это если имя листа не записывается изза сложного названия
